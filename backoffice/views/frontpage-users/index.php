...
<div class="user-index">
    ...
    <p>
        <?= Html::a('Create Frontpage User', ['create'], ['class' => 'btn btn-success']) ?>
    </p>
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'visibleButtons' => [
                    'view' => true,
                    'update' => \Yii::$app->user->can('edit-frontpage-user'),
                    'delete' => \Yii::$app->user->can('edit-frontpage-user'),
                ],
                'buttons' => [
