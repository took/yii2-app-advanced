...
<?php $this->beginPage() ?>
    ...
    <header>
        ...
        $menuItems = [['label' => 'Home', 'url' => ['/site/index']], ['label' => 'About', 'url' => ['/site/about']], ['label' => 'Fnord', 'url' => ['/fnord']], ['label' => 'Hidden Page', 'url' => ['/site/example-login-required'], 'visible' => !Yii::$app->user->isGuest], ['label' => 'Contact', 'url' => ['/site/contact']],];
