...
- `.gitignore` la liste des dossiers ignorés par le système de gestion de versions git. Si vous avez besoin que quelque
  chose ne remonte jamais dans votre dépôt de code source, ajoutez-le ici.
...
- `LICENSE.md` - les informations de licence. Placez la licence de votre projet ici. En particulier si vous le placez en
  open source.
- `README.md` - informations de base sur la façon d'installer le modèle de projet. Envisagez de remplacer ces
  informations par vos propres informations sur votre projet et son installation.
