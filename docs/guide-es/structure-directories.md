...
- `.gitignore` contiene una lista de directorios ignorados por git sistema de versiones. Si tu necesitas algo que nunca
  lo incluiras en tu repositorio de código fuente, añadelo ahí.
...
- `LICENSE.md` - información de la licencia. Pon la licencia de tu proyecto ahí. Especialmente cuando es de código
  abierto.
- `README.md` - información básica sobre la instalación de la plantilla. CConsiderar remplazar esto con la información
  de tu proyecto y su instalación.
