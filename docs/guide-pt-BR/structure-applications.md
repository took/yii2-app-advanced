...
apresentado ao usuário final. Backend é o painel administrativo, e contém dados de análise da aplicação e outras
...
Ambos frontend e backend são aplicações web e contem o diretório `web`. Esta é a raíz dos diretórios acessíveis pela
web, o
qual seu servidor deve apontar.

Cada aplicação possui seu próprio namespace e um alias correspondendo ao seu nome. O mesmo se aplica para o diretório "
common". 